...
Two middleware functions are provided by default in the `hipstr.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `hipstr.handler` namespace to manage the enabled middleware.
